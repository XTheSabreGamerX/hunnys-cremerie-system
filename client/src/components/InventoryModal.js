...
const InventoryModal = ({ item, items, mode = 'view', onSave, onDelete, onClose, setPopupMessage }) => {
	...
	const handleAdd = () => {
		...
		if (!itemId || !name || !stock || !category || !unitPrice) {
			setPopupMessage('Please fill in all of the required fields!');
			return;
		}
			...
			<div className="modal-overlay">
				<div className="modal-content">
					...
					<div className="modal-actions">
						{mode === 'view' && (
							<>
								<button onClick={() => setShowConfirm(true)} className="inventory-btn delete-btn">Delete</button>
								<button onClick={onClose} className="inventory-btn close-btn">Close</button>
							</>
						)}
						...
						{mode === 'add' && (
							<>
								...
								<button onClick={onClose} className="inventory-btn close-btn">Cancel</button>
							</>
						)}
					</div>
				</div>
